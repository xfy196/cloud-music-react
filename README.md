...
[在线体验地址](https://music.xxytime.top/)
...
1. 将项目 clone 下来
```shell
$ git clone https://github.com/xfy196/cloud-music-react.git
$ cd cloud-music-react
$ npm install
...
现在就在本地的8080端口访问了。如果要打包到线上，执行`npm run build`即可。
